...
{   public:
	...
	{
        ofstream myfile;
   	    myfile.open("member.txt",ios::app);
...
{   public:
	...
	{  
        ofstream myfile;
        myfile.open("trainers.txt",ios::app);
...
{   private:
	...
	void get_Time_Table(Time_Table tt)
	  ...
	  if(tt.chk == 0)
		...
		ofstream myfile;
		myfile.open("timetable.txt",ios::app);
			myfile << "DAY       " << "ACTIVITY"<< endl << endl;
...
getch();
	...
	cout<<"\t\t\t*                                   MADE BY:-                                            *\n";
	cout<<"\t\t\t*                                                                                        *\n";
	cout<<"\t\t\t*        ROHAN GUPTA                  ROCHAK Kr. JAIN               RAJAT DAGAR          *\n";
	cout<<"\t\t\t*                                                                                        *\n";
	cout<<"\t\t\t******************************************************************************************\n";
	cout<<"\n\n\n\n\t\t\t";
 	}
